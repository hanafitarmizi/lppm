            ...
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 ">
                            <a href="<?= $this->url->get('berita/tambah')?>"> <button type="button" class="btn btn-primary  btn-lg" ><i class="icon-plus-square s-24"></i>Tambahkan
                    ...
                    <?php foreach ($beritas as $berita) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?= $this->url->get('berita/edit/'.$berita->id_berita)?>"> <button type="button" class="btn btn-warning "><i class="icon-edit">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row">
                                            <form action="<?= $this->url->get('berita/delete/'.$berita->id_berita)?>" method="post">
